...
\begin{figure}[!ht]
	...
	\makebox[\textwidth][c]{\includegraphics[width=13.8cm]{Pictures/arquitetura}}
...
\begin{figure}[!ht]
	...
	\makebox[\textwidth][c]{\includegraphics[width=12cm]{Pictures/doc-vocab-stringstore}}
...
Collection of functions that implement some of spaCy's functionality: part-of-speech (POS) tagging, entity recognition, information about tokens, dependency visualization and token exceptions.
...
def generate_dependencies_graph(doc, style='service', characteristics=(False, 'white', 'black', 'Source Sans Pro')):
    '''
...
\begin{thebibliography}{99}
    ...
    \bibitem{spacy_features}
	spaCy,
	``Linguistic Features'',
	\textit{spaCy},
    \url{https://spacy.io/usage/linguistic-features}.

    \bibitem{spacy_training}
	spaCy,
    ...
    \bibitem{spacy_examples}
	spaCy,
	``Code Examples'',
	\textit{spaCy},
    \url{https://spacy.io/usage/examples}.

    \bibitem{spacy_example_explosion}
	Explosion AI (spaCy),
